...
import { Bell, House, Info, Layers, MenuIcon, Search, SlidersHorizontal } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="bg-zinc-950/85 text-zinc-400 px-4 py-2.5 flex backdrop-blur-sm items-center justify-between rounded-t-2xl">
          <NavLink
            to="/"
            className={({ isActive }) =>
