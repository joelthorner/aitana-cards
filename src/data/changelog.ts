    ...
    items: [
      {
        ...
        text: TOPPS_DECO_UEFA_CLUB_COMPETITIONS_2023_2024_9p.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_DECO_UEFA_CLUB_COMPETITIONS_2023_2024_9b,
        text: TOPPS_DECO_UEFA_CLUB_COMPETITIONS_2023_2024_9b.collection.name,
        user: 'joelthorner',
      },
      {
      ...
      },
      {
        ...
        text: TOPPS_DECO_UEFA_CLUB_COMPETITIONS_2023_2024_9gr.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_DECO_UEFA_CLUB_COMPETITIONS_2023_2024_9,
        text: TOPPS_DECO_UEFA_CLUB_COMPETITIONS_2023_2024_9.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
    ...
    items: [
      {
        ...
        text: PANINI_FIFA_WOMEN_S_WORLD_CUP_AUSTRALIA_NEW_ZEALAND_2023_J6.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.CHANGED,
      ...
      },
      {
        ...
        text: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_alt14g.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_alt14,
        text: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_alt14.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_14gr,
        text: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_14gr.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_14g,
        text: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_14g.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_14,
        text: TOPPS_UEFA_WOMEN_S_CHAMPIONS_LEAGUE_CHROME_SAPPHIRE_EDITION_2022_2023_14.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_NOW_WOMEN_S_CHAMPIONS_LEAGUE_2022_2023_23,
        text: TOPPS_NOW_WOMEN_S_CHAMPIONS_LEAGUE_2022_2023_23.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
      ...
      },
      {
        type: LineType.ADDED,
        card: TOPPS_FC_BARCELONA_WOMEN_WINNERS_TEAM_SET_2023_42gr,
        text: TOPPS_FC_BARCELONA_WOMEN_WINNERS_TEAM_SET_2023_42gr.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
      ...
      },
      {
        ...
        text: PANINI_LIGA_F_2022_2023_16.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: PANINI_LIGA_F_2022_2023_15,
        text: PANINI_LIGA_F_2022_2023_15.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: PANINI_LIGA_F_2023_2024_43,
        text: PANINI_LIGA_F_2023_2024_43.collection.name,
        user: 'joelthorner',
      },
    ],
  },
    ...
    items: [
      {
        ...
        text: TOPPS_MERLIN_HERITAGE_98_UCC_SEASON_2022_2023_85ao.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_98_UCC_SEASON_2022_2023_85r,
        text: TOPPS_MERLIN_HERITAGE_98_UCC_SEASON_2022_2023_85r.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_98_UCC_SEASON_2022_2023_85gr,
        text: TOPPS_MERLIN_HERITAGE_98_UCC_SEASON_2022_2023_85gr.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_98_UCC_SEASON_2022_2023_85b,
        text: TOPPS_MERLIN_HERITAGE_98_UCC_SEASON_2022_2023_85b.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70bu,
        text: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70bu.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70gr,
        text: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70gr.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70,
        text: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70pu,
        text: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70pu.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
        card: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70api,
        text: TOPPS_MERLIN_HERITAGE_UEFA_CLUB_COMPETITIONS_2023_2024_70api.collection.name,
        user: 'joelthorner',
      },
      {
        type: LineType.ADDED,
