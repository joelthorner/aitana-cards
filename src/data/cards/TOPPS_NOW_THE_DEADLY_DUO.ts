...
export const TOPPS_NOW_THE_DEADLY_DUO: Card = {
...
export const TOPPS_NOW_THE_DEADLY_DUO_PURPLE: Card = {
  id: 'topps-now-the-deadly-duo-purple',
  images: [
    toppsNowTheDeadlyDuo_purple,
    toppsNowTheDeadlyDuo_back,
  ],
  name: "The deadly duo purple /99",
  rarity: 4,
...
export const TOPPS_NOW_THE_DEADLY_DUO_BLACK: Card = {
  id: 'topps-now-the-deadly-duo-black',
  images: [
    toppsNowTheDeadlyDuo_black,
    toppsNowTheDeadlyDuo_back,
  ],
  name: "The deadly duo black /10",
  rarity: 4,
  status: CardStatus.Falti,
...
export const TOPPS_NOW_THE_DEADLY_DUO_GOLD: Card = {
...
export const TOPPS_NOW_THE_DEADLY_DUO_DUAL_AUTOGRAPH_PURPLE: Card = {
  id: 'topps-now-the-deadly-duo-dual-autograph-purple',
  images: [
    toppsNowTheDeadlyDuoDualAutograph,
  ],
  name: "The deadly duo - Dual Autograph purple /25",
  rarity: 5,
  status: CardStatus.Falti,
  brilli: CardBrilli.PurpleFoil,
  collection: ToppsNowWomenSChampionsLeague_2023_24,
...
export const TOPPS_NOW_THE_DEADLY_DUO_DUAL_AUTOGRAPH_BLACK: Card = {
  id: 'topps-now-the-deadly-duo-dual-autograph-black',
  images: [
    toppsNowTheDeadlyDuoDualAutograph_black,
  ],
  name: "The deadly duo - Dual Autograph black /10",
  rarity: 5,
  status: CardStatus.Falti,
  brilli: CardBrilli.BlackTopps,
  collection: ToppsNowWomenSChampionsLeague_2023_24,
...
export const TOPPS_NOW_THE_DEADLY_DUO_DUAL_AUTOGRAPH_RAINBOW: Card = {
  id: 'topps-now-the-deadly-duo-dual-autograph-rainbow',
  images: [
    toppsNowTheDeadlyDuoDualAutograph_rainbow,
  ],
  name: "The deadly duo - Dual Autograph rainbow /5",
  rarity: 5,
  status: CardStatus.Falti,
...
export const TOPPS_NOW_THE_DEADLY_DUO_DUAL_AUTOGRAPH_GOLD: Card = {
