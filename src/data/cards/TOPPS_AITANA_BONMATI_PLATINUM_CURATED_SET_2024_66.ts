...
import tabpcs_A66r_0 from "../img/cards/tabpcs_A66r_0.jpg";
import tabpcs_A66r_1 from "../img/cards/tabpcs_A66r_1.webp";
import tabpcs_A66r_2 from "../img/cards/tabpcs_A66r_2.webp";
...
export const TOPPS_AITANA_BONMATI_PLATINUM_CURATED_SET_2024_66bu: Card = {
  ...
  name: 'Gana el premio UEFA Women\'s Player of the Year 2022/23 - Blue',
  rarity: 3,
  numbered: 49,
  status: CardStatus.Falti,
  collection: ToppsAitanaBonmatiPlatinumCuratedSet_2024,
...
export const TOPPS_AITANA_BONMATI_PLATINUM_CURATED_SET_2024_66pu: Card = {
  id: 'topps-aitana-bonmati-platinum-curated-set-2024-66pu',
  number: '66pu',
  images: [
    tabpcs_66pu_0,
    tabpcs_66pu_1,
  ...
  name: 'Gana el premio UEFA Women\'s Player of the Year 2022/23 - Purple',
  rarity: 4,
  numbered: 25,
  status: CardStatus.Falti,
  collection: ToppsAitanaBonmatiPlatinumCuratedSet_2024,
...
export const TOPPS_AITANA_BONMATI_PLATINUM_CURATED_SET_2024_66r: Card = {
  id: 'topps-aitana-bonmati-platinum-curated-set-2024-66r',
  number: '66r',
  images: [
    tabpcs_66r_0,
    tabpcs_66r_1,
  ...
  name: 'Gana el premio UEFA Women\'s Player of the Year 2022/23 - Red',
  rarity: 5,
  numbered: 10,
  status: CardStatus.Falti,
  collection: ToppsAitanaBonmatiPlatinumCuratedSet_2024,
...
export const TOPPS_AITANA_BONMATI_PLATINUM_CURATED_SET_2024_A66r: Card = {
  id: 'topps-aitana-bonmati-platinum-curated-set-2024-A-66r',
  number: 'A-66r',
  images: [
    tabpcs_A66r_0,
    tabpcs_A66r_1,
  ...
  name: 'Gana el premio UEFA Women\'s Player of the Year 2022/23 Autographs / Red',
  rarity: 5,
  numbered: 10,
  status: CardStatus.Falti,
  collection: ToppsAitanaBonmatiPlatinumCuratedSet_2024,
...
export const TOPPS_AITANA_BONMATI_PLATINUM_CURATED_SET_2024_A66p: Card = {
  id: 'topps-aitana-bonmati-platinum-curated-set-2024-A-66p',
  number: 'A-66p',
  images: [
    tabpcs_A66p_0,
    tabpcs_A66p_1,
  ...
  name: 'Gana el premio UEFA Women\'s Player of the Year 2022/23 Autographs / Pink',
  rarity: 5,
  numbered: 5,
  status: CardStatus.Falti,
  collection: ToppsAitanaBonmatiPlatinumCuratedSet_2024,
