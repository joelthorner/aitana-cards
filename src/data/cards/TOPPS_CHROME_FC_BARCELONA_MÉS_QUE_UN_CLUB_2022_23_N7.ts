...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_N7: Card = {
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_REFRACTOR_N7: Card = {
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_BNW_REFRACTOR_N7: Card = {
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_X_FRACTOR_N7: Card = {
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_BARÇA_REFACTOR_N7: Card = {
  ...
  name: 'Aitana Bonmatí barça refactor /99 - #7',
  description: "",
  rarity: 2,
  status: CardStatus.Falti,
  brilli: CardBrilli.Refractor,
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_BLUE_N7: Card = {
  ...
  name: 'Aitana Bonmatí blue refractor /75 - #7',
  description: "",
  rarity: 4,
  status: CardStatus.Falti,
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_GOLD_N7: Card = {
  id: 'topps-chrome-fc-barcelona-més-que-un-club-2022-23-gold-n7',
  images: [
    aitanaBonmati_7ChromeFcb_22_23_gold_refractor,
  ],
  name: 'Aitana Bonmatí gold refractor /50 - #7',
  description: "",
  rarity: 5,
  status: CardStatus.Falti,
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_ORANGE_X_FRACTOR_N7: Card = {
  ...
  name: 'Aitana Bonmatí orange X-Fractor /25 - #7',
  description: "",
  rarity: 5,
  status: CardStatus.Falti,
  collection: ToppsChromeFcBarcelonaMésQueUnClub_2022_23,
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_PURPLE_REFRACTOR_N7: Card = {
  id: 'topps-chrome-fc-barcelona-més-que-un-club-2022-23-purple-refractor-n7',
  images: [],
  missingImage: aitanaBonmati_7ChromeFcb_22_23_refractor,
  name: 'Aitana Bonmatí purple refractor /15 - #7',
  description: "",
  rarity: 5,
  status: CardStatus.Falti,
  collection: ToppsChromeFcBarcelonaMésQueUnClub_2022_23,
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_RED_X_FRACTOR_N7: Card = {
  id: 'topps-chrome-fc-barcelona-més-que-un-club-2022-23-red-x-fractor-n7',
  images: [],
  missingImage: aitanaBonmati_7ChromeFcb_22_23_refractor,
  name: 'Aitana Bonmatí red X-Fractor /5 - #7',
  description: "",
  rarity: 5,
  status: CardStatus.Falti,
  collection: ToppsChromeFcBarcelonaMésQueUnClub_2022_23,
...
export const TOPPS_CHROME_FC_BARCELONA_MÉS_QUE_UN_CLUB_2022_23_SUPERFRACTOR_N7: Card = {
