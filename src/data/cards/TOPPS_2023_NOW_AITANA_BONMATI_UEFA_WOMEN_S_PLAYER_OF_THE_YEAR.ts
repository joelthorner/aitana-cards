...
export const TOPPS_2003_NOW_AITANA_BONMATI_UEFA_WOMEN_S_PLAYER_OF_THE_YEAR: Card = {
  id: 'topps-2023-now-aitana-bonmati-uefa-women-s-player-of-the-year',
  images: [
...
export const TOPPS_2003_NOW_AITANA_BONMATI_UEFA_WOMEN_S_PLAYER_OF_THE_YEAR_PURPLE: Card = {
  id: 'topps-2023-now-aitana-bonmati-uefa-women-s-player-of-the-year-purple',
  images: [
    ToppsNowAitanaBonmatiUefaWomenSPlayerOfTheYear2023_purple,
    ToppsNowAitanaBonmatiUefaWomenSPlayerOfTheYear2023_back,
  ],
  name: 'UEFA Women\'s Player of the Year purple /99',
  rarity: 3,
...
export const TOPPS_2003_NOW_AITANA_BONMATI_UEFA_WOMEN_S_PLAYER_OF_THE_YEAR_BLACK: Card = {
  id: 'topps-2023-now-aitana-bonmati-uefa-women-s-player-of-the-year-black',
  images: [
    ToppsNowAitanaBonmatiUefaWomenSPlayerOfTheYear2023_black,
    ToppsNowAitanaBonmatiUefaWomenSPlayerOfTheYear2023_back,
  ],
  name: 'UEFA Women\'s Player of the Year black /10',
  rarity: 4,
  status: CardStatus.Falti,
...
export const TOPPS_2003_NOW_AITANA_BONMATI_UEFA_WOMEN_S_PLAYER_OF_THE_YEAR_GOLD: Card = {
  id: 'topps-2023-now-aitana-bonmati-uefa-women-s-player-of-the-year-gold',
  images: [
